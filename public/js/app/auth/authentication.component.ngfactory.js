...
var _View_AuthenticationComponent0 = (function (_super) {
    ...
    _View_AuthenticationComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this.renderer.setElementAttribute(this._el_2, 'class', 'col-md7 col-md-offset-2');
        ...
        this._query_RouterLink_6_0 = new import12.QueryList();
        this._query_RouterLinkWithHref_6_1 = new import12.QueryList();
        ...
        this._text_8 = this.renderer.createText(this._el_7, 'Signup', null);
        this._text_9 = this.renderer.createText(this._el_4, '\n            ', null);
        this._anchor_10 = this.renderer.createTemplateAnchor(this._el_4, null);
        ...
        this._el_17 = this.renderer.createElement(parentRenderNode, 'div', null);
        this.renderer.setElementAttribute(this._el_17, 'class', 'row spacing');
        this._text_18 = this.renderer.createText(this._el_17, '\n    ', null);
        this._el_19 = this.renderer.createElement(this._el_17, 'router-outlet', null);
        this._appEl_19 = new import2.AppElement(19, 17, this, this._el_19);
        this._RouterOutlet_19_5 = new import15.RouterOutlet(this.parentInjector.get(import21.RouterOutletMap), this._appEl_19.vcRef, this.parentInjector.get(import22.ComponentFactoryResolver), null);
    ...
    _View_AuthenticationComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import13.RouterLinkWithHref) && ((7 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
            return this._RouterLinkWithHref_7_3;
        }
        if (((token === import11.RouterLinkActive) && ((6 <= requestNodeIndex) && (requestNodeIndex <= 8)))) {
        ...
        if (((token === import15.RouterOutlet) && (19 === requestNodeIndex))) {
            return this._RouterOutlet_19_5;
        }
        return notFoundResult;
    };
    ...
    _View_AuthenticationComponent0.prototype._handle_click_7_0 = function ($event) {
...
export function viewFactory_AuthenticationComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_AuthenticationComponent === null)) {
        (renderType_AuthenticationComponent = viewUtils.createRenderComponentType('C:/Users/Sebastian/Desktop/DEV/udemytutorial/03 MongoDB/assets/app/auth/authentication.component.html', 0, import9.ViewEncapsulation.None, styles_AuthenticationComponent, {}));
    }
