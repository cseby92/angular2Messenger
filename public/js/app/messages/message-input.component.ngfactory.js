...
var _View_MessageInputComponent0 = (function (_super) {
    ...
    _View_MessageInputComponent0.prototype.createInternal = function (rootSelector) {
        ...
        this.renderer.setElementAttribute(this._el_9, 'ngModel', '');
    ...
    _View_MessageInputComponent0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import11.NgForm) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
            return this._NgForm_2_3;
        }
        if (((token === import20.ControlContainer) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 14)))) {
...
export function viewFactory_MessageInputComponent0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_MessageInputComponent === null)) {
        (renderType_MessageInputComponent = viewUtils.createRenderComponentType('C:/Users/Sebastian/Desktop/DEV/udemytutorial/03 MongoDB/assets/app/messages/message-input.component.html', 0, import9.ViewEncapsulation.None, styles_MessageInputComponent, {}));
    }
