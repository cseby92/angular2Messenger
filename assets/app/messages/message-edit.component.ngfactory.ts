...
var renderType_MessageEditComponent_Host:import0.RenderComponentType = (null as any);
class _View_MessageEditComponent_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _MessageEditComponent_0_4:import3.MessageEditComponent;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_MessageEditComponent_Host0,renderType_MessageEditComponent_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
    this._el_0 = this.selectOrCreateHostElement('app-message-edit',rootSelector,(null as any));
    this._appEl_0 = new import2.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_MessageEditComponent0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    compView_0.create(this._MessageEditComponent_0_4,this.projectableNodes,(null as any));
    this.init([].concat([this._el_0]),[this._el_0],[],[]);
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import3.MessageEditComponent) && (0 === requestNodeIndex))) { return this._MessageEditComponent_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._MessageEditComponent_0_4.ngOnInit(); }
    this.detectContentChildrenChanges(throwOnChange);
    this.detectViewChildrenChanges(throwOnChange);
  }
}
function viewFactory_MessageEditComponent_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_MessageEditComponent_Host === (null as any))) { (renderType_MessageEditComponent_Host = viewUtils.createRenderComponentType('',0,import9.ViewEncapsulation.None,[],{})); }
  return new _View_MessageEditComponent_Host0(viewUtils,parentInjector,declarationEl);
}
export const MessageEditComponentNgFactory:import10.ComponentFactory<import3.MessageEditComponent> = new import10.ComponentFactory<import3.MessageEditComponent>('app-message-edit',viewFactory_MessageEditComponent_Host0,import3.MessageEditComponent);
const styles_MessageEditComponent:any[] = [];
var renderType_MessageEditComponent:import0.RenderComponentType = (null as any);
class _View_MessageEditComponent0 extends import1.AppView<import3.MessageEditComponent> {
  _el_0:any;
  _text_1:any;
  _el_2:any;
  ...
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement) {
    super(_View_MessageEditComponent0,renderType_MessageEditComponent,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import2.AppElement {
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import11.FormGroupDirective) && ((2 <= requestNodeIndex) && (requestNodeIndex <= 14)))) { return this._FormGroupDirective_2_3; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    changes = (null as any);
    const currVal_12:any = 'editField';
...
export function viewFactory_MessageEditComponent0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.MessageEditComponent> {
  if ((renderType_MessageEditComponent === (null as any))) { (renderType_MessageEditComponent = viewUtils.createRenderComponentType('C:/Users/Sebastian/Desktop/DEV/udemytutorial/03 MongoDB/assets/app/messages/message-edit.component.html',0,import9.ViewEncapsulation.None,styles_MessageEditComponent,{})); }
